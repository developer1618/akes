...
function showResults() {
  ...
  let resultHTML = `
    <div class="flex justify-center">
      <div
        class="container h-36 quiz-timeline border-2 py-2 px-8 rounded-2xl max-w-xl flex justify-center items-center align-middle bg-white mb-4">
  ...
  <div class="flex justify-between">
      <button onclick="location.reload()"
          class="flex justify-center w-full items-center bg-white border-2 transition duration-700 text-[#3E3E70] hover:bg-[#3E3E70] hover:text-white px-4 py-2 rounded-2xl mb-8 mr-8">Take
          the test again
          <span class="pl-2">
        ...
        <a href="start.html"
          class="flex justify-center w-full bg-white border-2 transition duration-700 text-[#3E3E70] hover:bg-[#3E3E70] hover:text-white px-4 py-2 rounded-2xl mb-8">Go
          to homepage</a>
      </div>
  `;
  for (let i = 0; i < quizData.length; i++) {
    ...
    resultHTML += `
      <div class="grid justify-center">
        <div class="quiz-question__block border-2 p-4 rounded-2xl bg-white mb-8">
